...
let myContact = new Contact('Vamshi', 'reddy', 'uppal', 'hyderabad', 'Telangana', '508126', '917730006563', 'vamshi@gmail.com');
newAddressBook.addContact(myContact);
let myContact2 = new Contact('Sai', 'kumar', 'madhapur', 'hyderabad', 'Telangana', '508003', '918778945462', 'saikumar@gmail.com');
// ContactArray.push(myContact2);
newAddressBook.addContact(myContact2);
let myContact3 = new Contact('Rahul', 'Reddy', 'Alwal', 'karimnagar', 'Andrapradesh', '500008', '918899445566', 'rahul@gmail.com');
// ContactArray.push(myContact3)
newAddressBook.addContact(myContact3);
newAddressBook.display();
newAddressBook.Edit("Vamshi","Varun");
newAddressBook.deleteContact("Rahul");
newAddressBook.numberofCOntact();
newAddressBook.searchBycity("Hyderabad");
//serch by state
newAddressBook.searchByState("Telangana")
newAddressBook.CountBycity("madhapur")
